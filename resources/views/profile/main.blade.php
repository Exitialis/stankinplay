    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            <form @submit.prevent="submit('{{ route('api.users.profile.university.update', auth()->id()) }}')">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>Группа:</label>
                                <v-select2 v-model="form.group_id" :ajax-url="'{{ route('api.groups.lists') }}'" :default-value="group"></v-select2>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12" data-toggle="tooltip" data-placement="top" title="*Модуль по физической культуре. Выставляется тем, кто прошел отборочные испытания.">
